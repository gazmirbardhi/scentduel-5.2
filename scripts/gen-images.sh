...
gen_frag "creed-original-santal" "Original Santal" "#5c3d1f" "#2e1f0d"
gen_frag "creed-royal-oud" "Royal Oud" "#2e1f3d" "#1a0d2e"
gen_frag "tom-ford-beau-de-jour" "Beau de Jour" "#2e5c1f" "#1a3d0d"
gen_frag "tom-ford-lost-cherry" "Lost Cherry" "#5c1f1f" "#3d0d0d"
gen_frag "tom-ford-fucking-fabulous" "Fucking Fabulous" "#5c1f3d" "#2e0d2e"
gen_frag "tom-ford-mandarino-di-amalfi" "Mandarino di Amalfi" "#1f5c6b" "#0d3d4a"
gen_frag "dior-homme-original" "Dior Homme Original" "#3d2e5c" "#1a0d2e"
gen_frag "dior-homme-sport" "Dior Homme Sport" "#5c4a1f" "#3d2e0d"
gen_frag "dior-oud-ispahan" "Oud Ispahan" "#2e1f14" "#5c3d1f"
gen_frag "chanel-allure-homme-sport" "Allure Homme Sport" "#1f3d5c" "#0d1f33"
gen_frag "chanel-egoiste" "Égoïste" "#5c2e0d" "#3d1f05"
gen_frag "chanel-pour-monsieur" "Pour Monsieur" "#3d3d3d" "#1a1a1a"
gen_frag "guerlain-shalimar" "Shalimar" "#5c3d1f" "#2e1f0d"
gen_frag "guerlain-linstant-pour-homme" "L'Instant Homme" "#1f1f3d" "#0d0d2e"
gen_frag "hermes-un-jardin-sur-le-nil" "Un Jardin sur le Nil" "#2e5c4a" "#1a3d2e"
gen_frag "hermes-terre-eau-glacee" "Terre Eau Givrée" "#1f5c6b" "#0d3d4a"
gen_frag "mfk-aqua-celestia" "Aqua Celestia" "#1f5c7a" "#0d3d5c"
gen_frag "mfk-aqua-vitae" "Aqua Vitae" "#5c5c1f" "#3d3d0d"
gen_frag "parfums-de-marly-pegasus" "Pegasus" "#3d2e5c" "#1a0d2e"
gen_frag "parfums-de-marly-carlisle" "Carlisle" "#3d2e1f" "#5c4a2e"
gen_frag "parfums-de-marly-greenley" "Greenley" "#2e7a1f" "#1a4d0d"
gen_frag "ysl-kouros" "Kouros" "#7a7a5c" "#3d3d2e"
gen_frag "ysl-libre" "Libre" "#5c4a1f" "#3d2e0d"
gen_frag "versace-eros-flame" "Eros Flame" "#5c1f0d" "#3d0d05"
gen_frag "armaf-tres-nuit" "Tres Nuit" "#2e5c1f" "#1a3d0d"
gen_frag "armaf-aura-fresh" "Aura Fresh" "#1f5c7a" "#0d3d4a"
gen_frag "jpg-scandal-pour-homme" "Scandal Pour Homme" "#5c4a1f" "#3d2e0d"
